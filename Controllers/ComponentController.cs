...
namespace DeltaPlan2100API.Controllers
{
    ...
    public class ComponentController : ControllerBase
    {
        ...
        {
            var comLevelOneList = db.TblComponentLevel1.Where(w => w.IsActive == true).OrderBy(o => o.ComponentLevel1Id).ToList();
        ...
        {
            var comLevelTwoList = db.TblComponentLevel2.Where(w => w.IsActive == true).OrderBy(o => o.ComponentLevel2Id).ToList();
        ...
        {
            var comLevelTwoItem = db.TblComponentLevel2.Where(w => w.ParentId == id && w.IsActive == true).OrderBy(o => o.ComponentLevel2Id).ToList();
        ...
        {
            var comLevelThreeList = db.TblComponentLevel3.Where(w => w.IsActive == true).OrderBy(o => o.ComponentLevel3Id).ToList();
        ...
        {
            var comLevelThreeItem = db.TblComponentLevel3.Where(w => w.ParentId == id && w.IsActive == true).OrderBy(o => o.ComponentLevel3Id).ToList();
